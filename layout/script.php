...
$url = 'http://10.241.10.11/website/views/';
...
$header = '<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>BancoV</b>Milho</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Relatórios de Venda</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Relatórios Diarios</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>Relatórios de Cotas</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>Relatórios de Clientes</a></li>
          </ul>
        </li>
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>Manual do Sistema</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="'.$url.'cliente/addcliente.php"><i class="fa fa-circle-o"></i>Add Clientes</a></li>
            <li><a href="'.$url.'cota/"><i class="fa fa-circle-o"></i>Consultar Cota</a></li>
             <li><a href="'.$url.'itens/totalitens.php"><i class="fa fa-circle-o"></i>Total Itens</a></li>
            <li><a href="'.$url.'itens/additens.php"><i class="fa fa-circle-o"></i>Add Itens</a></li>
          </ul>
        </li>
          ...
          <a href="#">
            <i class="fa fa-table"></i>
            <span>Representante/Clientes</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li>
          <a href="https://webmail.conab.gov.br">
  ...
  $footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2020 <a href="http://10.241.10.11/">Web Desenvolvedor Tony Marle - Sureg/AC</a>.</strong> Todos direitos Reservados.
  </footer>
...
<script type="text/javascript">
$("#valor").mask("99.999", {reverse: true})
</script>
